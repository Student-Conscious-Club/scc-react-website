  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-primary-500 to-secondary-500 text-white py-3 z-50">
      <div className="relative overflow-hidden">
        <div
          className={`flex whitespace-nowrap ${isAnimating ? "animate-[marquee_20s_linear_infinite]" : ""}`}
          onMouseEnter={() => setIsAnimating(false)}
          onMouseLeave={() => setIsAnimating(true)}>
          <Link
            href="https://forms.gle/rw38dYmkXCTF54HF7"
            target="_blank"
            className="mx-4 text-warm-100 hover:text-warm-200 transition-colors duration-300 flex items-center space-x-2">
